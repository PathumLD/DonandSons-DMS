      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1" style={{ color: '#6B7280' }}>
            Record product returns from showrooms to production (32 entries)
          </p>
        </div>
        ...
        <CardContent>
          <div className="flex items-center justify-center py-12">
            <div className="text-center">
              <CornerUpLeft className="w-16 h-16 mx-auto mb-4" style={{ color: '#9CA3AF' }} />
              <h3 className="text-lg font-medium mb-2" style={{ color: '#111827' }}>
                Delivery Return Module
              </h3>
              <p className="text-sm" style={{ color: '#6B7280' }}>
                Return to production interface will be implemented here
              </p>
            </div>
          </div>
        </CardContent>
